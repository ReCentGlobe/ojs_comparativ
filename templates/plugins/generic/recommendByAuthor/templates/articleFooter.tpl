 ...
 *}
<div id="articlesBySameAuthorList" class="uk-container uk-margin uk-margin-large uk-margin-remove-horizontal " uk-scrollspy="&#123;&quot;target&quot;:&quot;[uk-scrollspy-class]&quot;,&quot;cls&quot;:&quot;uk-animation-fade&quot;,&quot;delay&quot;:300&#125">
						...
						{assign var=journal value=$articleBySameAuthor.journal}
							<article class="uk-margin-medium uk-margin-remove-top uk-panel uk-article" >
								...
								<div uk-grid uk-scrollspy-class>
									<div class="uk-width-1-1">
										<a class="uk-link-reset" href="{url journal=$journal->getPath() page="article" op="view" path=$publishedArticle->getBestId()}">
