 ...
 *}
<ul id="navigationPrimary" class="flex gap-6 items-center text-base font-medium text-gray-800 dark:text-gray-200">
	...
	{if $currentJournal}
		...
		<li>
			<a href="{url router=$smarty.const.ROUTE_PAGE page="about"}">
				...
				<ul class="ml-4 mt-2 space-y-1 border-l-2 border-primary pl-4">
					<li>
						<a href="{url router=$smarty.const.ROUTE_PAGE page="about"}">
