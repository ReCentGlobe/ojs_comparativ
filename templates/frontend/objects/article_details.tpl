...
{/if}
<article class="obj_article_details bg-white border border-gray-200 md:border-l-4 md:border-l-primary-light rounded-md md:rounded-md p-2 sm:p-4 md:p-8 my-8 md:my-12">
