 ...
 *}
<div class="obj_issue_toc container mx-auto bg-white border border-gray-200 md:border-l-4 md:border-l-primary-light rounded-md md:rounded-md rounded p-4 md:p-8 my-12">
